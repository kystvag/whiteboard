          ...
          > 
            ...
            <div style={{ paddingTop: "8px" }}> 
              <div style={{ 
                ...
                fontWeight: "550", 
                lineHeight: "18px" 
              }}>Se dette innlegget på Instagram</div> 
            </div> 
          </a>
          <p style={{ 
            color: "#c9c8cd", 
            ...
            <a href="https://www.instagram.com/p/DEAiZx6M51i/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ 
              color: "#c9c8cd", 
              fontFamily: "Arial,sans-serif", 
              fontSize: "14px", 
              fontStyle: "normal", 
              ...
              lineHeight: "17px", 
              textDecoration: "none" 
            }} target="_blank">Et innlegg delt av Hugo Tønnesen Kystvåg (@kystvag)</a> 
          </p> 
        </div>
      </blockquote>
